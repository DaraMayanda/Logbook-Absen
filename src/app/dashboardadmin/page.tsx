...
export default function DashboardAdmin() {
  ...
  // --- Fetch total pegawai & realtime listener ---
  useEffect(() => {
  ...
  const FeatureCard = ({
    ...
    <a
      href={href}
      className="flex items-center p-4 bg-white rounded-xl shadow-md hover:shadow-lg transition duration-300 border border-gray-100 transform hover:scale-[1.01]"
    >
      ...
      <main className="px-5 -mt-10 pb-10">
        ...
        <div className="flex flex-col gap-4">
          <FeatureCard
            icon={FileText}
            title="Data Pegawai"
            description="Lihat semua data pegawai."
            href="/datapegawai"
          />
          <FeatureCard
            icon={Briefcase}
            title="Approval Cuti"
            description="Lihat dan approve pengajuan cuti pegawai."
            href="/approvalcuti"
          />
          <FeatureCard
            icon={BarChart2}
            ...
            href="/rekapabsensiadmin"
          />
          <FeatureCard
            icon={BookOpenCheck}
            title="Logbook Pegawai"
            description="Lihat dan cetak laporan harian pegawai."
            href="/logbookpegawaiadmin"
          />
        </div>
